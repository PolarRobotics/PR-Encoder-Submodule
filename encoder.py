...
#     ; 00 state
    ...
    jmp("increment") # read 0001
    jmp("decrement") # read 0010
    jmp("update")    # read 0011

# ; 01 state
    jmp("decrement") # read 0100
    jmp("update")    # read 0101
    jmp("update")    # read 0110
    jmp("increment") # read 0111

# ; 10 state
    jmp("increment") # read 1000 ( Seems to work for decrementing 9/23 )
    jmp("update")    # read 1001
    jmp("update")    # read 1010
    jmp("decrement") # read 1011
